...
<section id="custom-field"
            ...
            <tr>
                ...
                <td>
                    ...
                    <select name="fieldTypes[]" id="fieldtype">
                        <option
                            value="str"<?php if ('str' == $field['type']): ?> selected<?php endif; ?>><?php _e('Ký tự'); ?></option>
                        <option
                            value="int"<?php if ('int' == $field['type']): ?> selected<?php endif; ?>><?php _e('Số nguyên'); ?></option>
                        <option
                            value="float"<?php if ('float' == $field['type']): ?> selected<?php endif; ?>><?php _e('Thập phân'); ?></option>
                    </select>
                </td>
                <td>
                ...
                <td>
                    <button type="button" class="btn btn-xs"><?php _e('Xóa'); ?></button>
                </td>
            </tr>
        <?php endforeach; ?>
    ...
    <div class="description clearfix">
        <button type="button" class="btn btn-xs operate-add"><?php _e('+Thêm các lĩnh vực'); ?></button>
        <?php _e('Vui lòng tham khảo <a href="http://docs.typecho.org/help/custom-fields">tài liệu trợ giúp</a> để biết cách sử dụng chúng'); ?>
    </div>
</section>
