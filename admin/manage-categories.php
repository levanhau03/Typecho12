                        ...
                        <div class="operate">
                            ...
                            <div class="btn-group btn-drop">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a lang="<?php _e('Tất cả nội dung thuộc danh mục này sẽ bị xóa, bạn có chắc chắn muốn xóa các danh mục này không?'); ?>"
                                           href="<?php $security->index('/action/metas-category-edit?do=delete'); ?>"><?php _e('Xóa'); ?></a>
                                    </li>
                                    ...
                                    <li class="multiline">
                                        <button type="button" class="btn merge btn-s"
                                                rel="<?php $security->index('/action/metas-category-edit?do=merge'); ?>"><?php _e('Hợp nhất với'); ?></button>
                                        <select name="merge">
                    ...
                    <div class="typecho-table-wrap">
                        <table class="typecho-list-table">
                            ...
                            <tr class="nodrag">
                                ...
                                <th><?php _e('Tên'); ?></th>
                                <th><?php _e('Danh mục phụ'); ?></th>
                                <th class="kit-hidden-mb"><?php _e('Tên viết tắt'); ?></th>
                                <th></th>
                                <th class="kit-hidden-mb"><?php _e('Số lượng bài'); ?></th>
                            </tr>
                            </thead>
                            <tbody>
                                    ...
                                    <tr id="mid-<?php $categories->theId(); ?>">
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php $categories->permalink(); ?>"
                                               title="<?php _e('Duyệt qua %s', $categories->name); ?>"><i class="i-exlink"></i></a>
                                        </td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <a href="<?php $options->adminUrl('category.php?parent=' . $categories->mid); ?>"><?php echo _e('Thêm'); ?></a>
                                            <?php endif; ?>
                                        </td>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="6"><h6 class="typecho-list-table-title"><?php _e('Không có danh mục'); ?></h6>
                                    </td>
                                </tr>
                            <?php endif; ?>
                            </tbody>
