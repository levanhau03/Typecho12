            ...
            <div class="col-mb-12 typecho-list">
                <div class="clearfix">
                    ...
                    <ul class="typecho-option-tabs">
                        ...
                        . (isset($request->cid) ? '?cid=' . $request->cid : '')); ?>"><?php _e('Chấp thuận'); ?></a></li>
                        ...
                        . (isset($request->cid) ? '&cid=' . $request->cid : '')); ?>"><?php _e('Rác'); ?>
                    ...
                    <form method="get">
                        <div class="operate">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<?php $security->index('/action/comments-edit?do=approved'); ?>"><?php _e('chấp thuận'); ?></a></li>
                                <li><a href="<?php $security->index('/action/comments-edit?do=waiting'); ?>"><?php _e('chờ xem xét'); ?></a></li>
                                <li><a href="<?php $security->index('/action/comments-edit?do=spam'); ?>"><?php _e('rác'); ?></a></li>
                        ...
                        ?>">
                            ...
                            <td valign="top" class="comment-body">
                                ...
                                <div class="comment-action hidden-by-mouse">
                                    ...
                                    <span class="weak"><?php _e('chấp thuận'); ?></span>
                                    <?php else: ?>
                                    <a href="<?php $security->index('/action/comments-edit?do=approved&coid=' . $comments->coid); ?>" class="operate-approved"><?php _e('chấp thuận'); ?></a>
                                    <?php endif; ?>
                                    ...
                                    <span class="weak"><?php _e('rác'); ?></span>
                                    <?php else: ?>
                                    <a href="<?php $security->index('/action/comments-edit?do=spam&coid=' . $comments->coid); ?>" class="operate-spam"><?php _e('rác'); ?></a>
                                    <?php endif; ?>
                                    
                                    <a href="#<?php $comments->theId(); ?>" rel="<?php $security->index('/action/comments-edit?do=edit&coid=' . $comments->coid); ?>" class="operate-edit"><?php _e('Sửa'); ?></a>
                                    ...
                                    <a lang="<?php _e('Bạn có chắc chắn muốn xóa bình luận của %s không?', htmlspecialchars($comments->author)); ?>" href="<?php $security->index('/action/comments-edit?do=delete&coid=' . $comments->coid); ?>" class="operate-delete"><?php _e('Xóa'); ?></a>
                                </div>
                            </td>
                        </tr>
                        <?php endwhile; ?>
