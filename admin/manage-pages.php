                        ...
                        <div class="operate">
                            ...
                            <div class="btn-group btn-drop">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a lang="<?php _e('Bạn có chắc chắn muốn xóa các trang này không?'); ?>"
                                           href="<?php $security->index('/action/contents-page-edit?do=delete'); ?>"><?php _e('Xóa'); ?></a>
                                    </li>
                                    <li>
                                        <a href="<?php $security->index('/action/contents-page-edit?do=mark&status=publish'); ?>"><?php _e('Đánh dấu là <strong>%s</strong>', _t('công khai')); ?></a>
                                    </li>
                                    <li>
                                        <a href="<?php $security->index('/action/contents-page-edit?do=mark&status=hidden'); ?>"><?php _e('Đánh dấu là <strong>%s</strong>', _t('ẩn')); ?></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <form method="post" name="manage_pages" class="operate-form">
                    <div class="typecho-table-wrap">
                        <table class="typecho-list-table">
                                    ...
                                    <tr id="<?php $pages->theId(); ?>">
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php $options->adminUrl('write-page.php?cid=' . $pages->cid); ?>"
                                               title="<?php _e('Sửa %s', htmlspecialchars($pages->title)); ?>"><i
                                                    class="i-edit"></i></a>
                                            <?php if ('page_draft' != $pages->type): ?>
                                                <a href="<?php $pages->permalink(); ?>"
                                                   title="<?php _e('Duyệt qua %s', htmlspecialchars($pages->title)); ?>"><i
                                                        class="i-exlink"></i></a>
                                            <?php endif; ?>
                                        </td>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="6"><h6 class="typecho-list-table-title"><?php _e('Không có trang'); ?></h6>
                                    </td>
                                </tr>
                            <?php endif; ?>
                            </tbody>
