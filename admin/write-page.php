                ...
                <div class="col-mb-12 col-tb-9" role="main">
                    <?php if ($page->draft): ?>
                        <?php if ($page->draft['cid'] != $page->cid): ?>
                            ...
                            <cite
                                class="edit-draft-notice"><?php _e('Bản nháp hiện đang được chỉnh sửa được lưu trong %s, bạn có thể <a href="%s">xóa nó</a>', $pageModifyDate->word(),
                    ...
                    <p class="submit clearfix">
                        ...
                        <span class="right">
                            ...
                            <button type="button" id="btn-preview" class="btn"><i
                                    class="i-exlink"></i> <?php _e('Xem trước trang'); ?></button>
