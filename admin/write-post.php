            ...
            <form action="<?php $security->index('/action/contents-post-edit'); ?>" method="post" name="write_post">
                <div class="col-mb-12 col-tb-9" role="main">
                    <?php if ($post->draft): ?>
                        ...
                        <?php else: ?>
                            <cite class="edit-draft-notice"><?php _e('Hiện tại chỉnh sửa là một bản nháp chưa được xuất bản'); ?></cite>
                        <?php endif; ?>
                    ...
                    <p class="submit clearfix">
                        <span class="left">
                            <button type="button" id="btn-cancel-preview" class="btn"><i
                                    class="i-caret-left"></i> <?php _e('Hủy bản xem trước'); ?></button>
                        </span>
                        <span class="right">
                            ...
                            <button type="submit" name="do" value="save" id="btn-save"
                                    class="btn"><?php _e('Dự thảo bảo quản'); ?></button>
                                    ...
                                    <p>
                                        <select id="visibility" name="visibility">
                                            <?php if ($user->pass('editor', true)): ?>
                                                ...
                                                <option
                                                    value="password"<?php if (strlen($post->password) > 0): ?> selected<?php endif; ?>><?php _e('Mật khẩu bảo vệ'); ?></option>
                                                <option
                                                    value="private"<?php if ($post->status == 'private'): ?> selected<?php endif; ?>><?php _e('Riêng tư'); ?></option>
                                            <?php endif; ?>
                                            <option
                                                value="waiting"<?php if (!$user->pass('editor', true) || $post->status == 'waiting'): ?> selected<?php endif; ?>><?php _e('Đang chờ xem xét'); ?></option>
                                        </select>
                                    </p>
