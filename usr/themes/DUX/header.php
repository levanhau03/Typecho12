...
<?php endif; ?>
            ...
            <ul class="site-nav site-navbar">
                <li><a href="<?php $this->options ->siteUrl(); ?>"><i class="fa fa-home"></i>Trang chủ</a></li>

<?php if ($this->options->categorymenu == 'able'): ?>
                <li>
                    <a><i class="fa fa-folder-open"></i>Danh mục</a>
                    <ul class="sub-menu">
...
<?php if ($this->options->pagemenu == 'able'): ?>
                <li>
                    <a><i class="fa fa-file-text-o"></i>Trang</a>
                    <ul class="sub-menu">
    ...
    <div class="site-search">
        <div class="container">
            <form method="post" class="site-search-form" action="<?php $this->options ->siteUrl(); ?>">
                <input class="search-input" name="s" type="text" placeholder="Nhập từ khóa" value="">
