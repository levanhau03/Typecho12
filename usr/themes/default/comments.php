...
<div id="comments">
    ...
    <?php if ($comments->have()): ?>
        <h3><?php $this->commentsNum(_t('Chưa có bình luận'), _t('Chỉ 1 bình luận'), _t('Có %d bình luận')); ?></h3>

        <?php $comments->listComments(); ?>

        <?php $comments->pageNav('&laquo; Trang trước', 'Trang tiếp &raquo;'); ?>
        ...
        <div id="<?php $this->respondId(); ?>" class="respond">
            ...
            <form method="post" action="<?php $this->commentUrl() ?>" id="comment-form" role="form">
                <?php if ($this->user->hasLogin()): ?>
                    <p><?php _e('Thông tin đăng nhập: '); ?><a
