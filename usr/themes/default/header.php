...
<head>
    ...
    <title><?php $this->archiveTitle([
            'category' => _t('Các bài viết thuộc danh mục %s'),
            'search'   => _t('Các bài viết có chứa từ khóa %s'),
            'tag'      => _t('Các bài viết dưới nhãn %s'),
            'author'   => _t('Các bài viết được xuất bản bởi %s')
