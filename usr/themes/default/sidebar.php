...
<div class="col-mb-12 col-offset-1 col-3 kit-hidden-tb" id="secondary" role="complementary">
    ...
    <?php if (!empty($this->options->sidebarBlock) && in_array('ShowRecentComments', $this->options->sidebarBlock)): ?>
        <section class="widget">
            <h3 class="widget-title"><?php _e('Câu trả lời gần đây'); ?></h3>
            <ul class="widget-list">
        ...
        <section class="widget">
            ...
            <ul class="widget-list">
                <?php if ($this->user->hasLogin()): ?>
                    <li class="last"><a href="<?php $this->options->adminUrl(); ?>"><?php _e('AdminCP'); ?>
                ...
                <?php endif; ?>
                <li><a href="<?php $this->options->feedUrl(); ?>"><?php _e('RSS bài viết'); ?></a></li>
                <li><a href="<?php $this->options->commentsFeedUrl(); ?>"><?php _e('RSS bình luận'); ?></a></li>
