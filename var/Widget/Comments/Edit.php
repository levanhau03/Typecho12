...
class Edit extends Comments implements ActionInterface
{
    ...
    public function waitingComment()
    {
        ...
        Notice::alloc()
            ->set(
                $updateRows > 0 ? _t('Bình luận bị gắn cờ đang chờ xử lý') : _t('Không có bình luận nào bị gắn cờ đang chờ xử lý'),
    ...
    public function approvedComment()
    {
        ...
        Notice::alloc()
            ->set(
                $updateRows > 0 ? _t('Bình luận đã được thông qua') : _t('Không có bình luận nào được thông qua'),
                $updateRows > 0 ? 'success' : 'notice'
            );
    ...
    public function editComment(): bool
    {
        ...
        $this->response->throwJson([
            'success' => 0,
            'message' => _t('Không sửa được bình luận')
        ]);
    }
