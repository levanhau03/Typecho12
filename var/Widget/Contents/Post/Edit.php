...
class Edit extends Contents implements ActionInterface
{
    ...
    public function execute()
    {
        ...
        if (!empty($this->request->cid) && 'delete' != $this->request->do) {
            ...
            if (!$this->have()) {
                throw new Exception(_t('Bài viết không tồn tại'), 404);
    ...
    public function markPost()
    {
        ...
        Notice::alloc()
            ->set(
                $markCount > 0 ? _t('Bài viết bị gắn cờ là <strong>%s</strong>', $statusList[$status]) : _t('Không có bài viết nào bị gắn cờ'),
    ...
    public function deletePost()
    {
        ...
        /** 设置提示信息 */
        Notice::alloc()->set(
            $deleteCount > 0 ? _t('Bài viết đã bị xóa') : _t('Không có bài viết nào bị xóa'),
