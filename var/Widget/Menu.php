...
class Menu extends Base
{
    ...
    {
        $parentNodes = [null, _t('Bảng điều khiển'), _t('Đăng'), _t('Quản lý'), _t('Thiết lập')];
        ...
        $childNodes = [
            ...
            [
                [_t('Tổng quát'), _t('Tóm tắt trang web'), 'index.php', 'subscriber'],
                [_t('Thiết lập cá nhân'), _t('Thiết lập cá nhân'), 'profile.php', 'subscriber'],
                [_t('Plugin'), _t('Quản lý plugin'), 'plugins.php', 'administrator'],
                [[Config::class, 'getMenuTitle'], [Config::class, 'getMenuTitle'], 'options-plugin.php?config=', 'administrator', true],
                [_t('Ngoại hình'), _t('Ngoại hình'), 'themes.php', 'administrator'],
                [[Files::class, 'getMenuTitle'], [Files::class, 'getMenuTitle'], 'theme-editor.php', 'administrator', true],
                [_t('Đặt ngoại hình'), _t('Đặt ngoại hình'), 'options-theme.php', 'administrator', true],
                [_t('Sao lưu'), _t('Sao lưu'), 'backup.php', 'administrator'],
                [_t('Nâng cấp'), _t('Quy trình nâng cấp'), 'upgrade.php', 'administrator', true],
                [_t('Chào mừng'), _t('Chào mừng'), 'welcome.php', 'subscriber', true]
            ],
            [
                [_t('Viết một bài'), _t('Đăng một bài viết mới'), 'write-post.php', 'contributor'],
            ...
            [
                ...
                [_t('Trang'), _t('Quản lý các trang'), 'manage-pages.php', 'editor', false, 'write-page.php'],
                ...
                [_t('Danh mục'), _t('Quản lý danh mục'), 'manage-categories.php', 'editor', false, 'category.php'],
                [_t('Danh mục mới'), _t('Danh mục mới'), 'category.php', 'editor', true],
                ...
                [_t('Nhãn'), _t('Quản lý nhãn'), 'manage-tags.php', 'editor'],
                [[TagAdmin::class, 'getMenuTitle'], [TagAdmin::class, 'getMenuTitle'], 'manage-tags.php?mid=', 'editor', true],
                [_t('Tài liệu'), _t('Quản lý tệp'), 'manage-medias.php', 'editor'],
                [[AttachmentEdit::class, 'getMenuTitle'], [AttachmentEdit::class, 'getMenuTitle'], 'media.php?cid=', 'contributor', true],
                [_t('Người dùng'), _t('Quản lý người dùng'), 'manage-users.php', 'administrator', false, 'user.php'],
                [_t('Những người dùng mới'), _t('Những người dùng mới'), 'user.php', 'administrator', true],
            ...
            [
                ...
                [_t('Permalink'), _t('Cài đặt Permalink'), 'options-permalink.php', 'administrator'],
            ]
        ];
