...
class Edit extends Users implements ActionInterface
{
    ...
    public function form(?string $action = null): Form
    {
        ...
        /** 用户名称 */
        $name = new Form\Element\Text('name', null, null, _t('Tên tài khoản') . ' *', _t('Tên người dùng này sẽ là tên được sử dụng khi người dùng đăng nhập.')
        ...
        /** 用户昵称 */
        $screenName = new Form\Element\Text('screenName', null, null, _t('Biệt hiệu của người dùng'), _t('Biệt hiệu của người dùng có thể khác với tên người dùng, được sử dụng để hiển thị nền trước.')
        ...
        $group = new Form\Element\Select(
            ...
            null,
            _t('Nhóm người dùng'),
            _t('Các nhóm người dùng khác nhau có các quyền khác nhau.') . '<br />' . _t('Để biết bảng phân bổ quyền cụ thể, vui lòng <a href="http://docs.typecho.org/develop/acl">tham khảo tại đây</a>.')
        );
        $form->addInput($group);
        ...
        if ('insert' == $action) {
            ...
            $name->addRule([$this, 'nameExists'], _t('Tên đăng kí đã được sử dụng'));
