...
class Profile extends Edit implements ActionInterface
{
    ...
    public function optionsForm(): Form
    {
        ...
        $markdown = new Form\Element\Radio(
            ...
            _t('Chỉnh sửa và phân tích cú pháp nội dung bằng cú pháp Markdown'),
            _t('Sử dụng cú pháp <a href="http://daringfireball.net/projects/markdown/">Markdown</a> có thể giúp quá trình viết của bạn dễ dàng và trực quan hơn.')
        ...
        $xmlrpcMarkdown = new Form\Element\Radio(
            ...
            _t('Đối với các trình chỉnh sửa ngoại tuyến hỗ trợ đầy đủ cách viết ngữ pháp <a href="http://daringfireball.net/projects/markdown/">Markdown</a> , việc bật tùy chọn này sẽ ngăn nội dung được chuyển đổi sang HTML.')
        );
        ...
        $autoSave = new Form\Element\Radio(
            ...
            _t('Tự động lưu'),
            _t('Chức năng tự động lưu có thể bảo vệ tốt hơn các bài viết của bạn không bị mất.')
        );
        ...
        $defaultAllow = new Form\Element\Checkbox(
            'defaultAllow',
            ['comment' => _t('Có thể được bình luận'), 'ping' => _t('Có thể được trích dẫn'), 'feed' => _t('Xuất hiện trong feed')],
            $allow,
            _t('Được phép theo mặc định'),
            _t('Đặt các quyền mặc định mà bạn sử dụng thường xuyên')
        );
    ...
    public function profileForm()
    {
        ...
        /** 用户昵称 */
        $screenName = new Form\Element\Text('screenName', null, null, _t('Biệt hiệu'), _t('Biệt hiệu của người dùng có thể khác với tên người dùng, được sử dụng để hiển thị nền trước.')
        ...
        /** 电子邮箱地址 */
        $mail = new Form\Element\Text('mail', null, null, _t('Địa chỉ email') . ' *', _t('Địa chỉ email sẽ là phương thức liên hệ chính của người dùng này.')
    ...
    public function passwordForm(): Form
    {
        ...
        /** 用户密码 */
        $password = new Form\Element\Password('password', null, null, _t('Mật khẩu người dùng'), _t('Gán mật khẩu cho người dùng này.')
        ...
        /** 用户密码确认 */
        $confirm = new Form\Element\Password('confirm', null, null, _t('Xác nhận mật khẩu người dùng'), _t('Vui lòng xác nhận mật khẩu của bạn, mật khẩu này phù hợp với mật khẩu đã nhập ở trên.'));
    ...
    public function updatePersonal()
    {
        ...
        /** 提示信息 */
        Notice::alloc()->set(_t("%s cài đặt đã được lưu", $info['title']), 'success');
